...
imnameMF_TV = ['D:\doc\mathdoc\图像处理\NL-LRTC\Els_paper\figure\MF_TV_',num2str(v),'_',num2str(SR),'.eps'];
...
enlarge(Re_tensor{3});print(gcf,'-depsc',imnameMF_TV)
enlarge(Re_tensor{2});print(gcf,'-depsc',imnameTMac)
